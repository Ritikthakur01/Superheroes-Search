      ...
      if (responseJSON.response == "success") {
        responseJSON.results.forEach((element) => {
         ...
         <div class="poster-container">
           <a href="#"><img src="${element.image.url}" /></a>
         </div>
         <div class="ticket-container">
           <div class="ticket__content">
             <h4 class="character-name">${element.name}</h4>
             
             <button id="${element.id}" onclick="addFavourite(${element.id})" class="ticket__buy-btn">Add to fav.</button>
           </div>
         </div>
       </div> `
